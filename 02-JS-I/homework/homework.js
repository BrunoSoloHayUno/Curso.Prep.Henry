...
function agregarSimboloExclamacion(str) {
  // Agrega un símbolo de exclamación al final de el string "str" y devuelve una nuevo string
...
function obtenerSaludo(nombre) {
  ...
  var hola = "Hola";
  var esclamacion = "!"
  var saludo = hola + " " + nombre + esclamacion; 
  return saludo;
}
